          ...
          getDeclaration(name, type, length) {
            ...
            if (uniform.excludeFrom !== type) {
              ...
              if (uniform.type === 'struct') {
                ...
                return (
                  (name_no_prefix = name_no_prefix.charAt(0).toUpperCase()
              ...
              for (let t = 0; t <= n.xSegCount; t++) {
                ...
                if (
                  ...
                  (n.attributes.uvNorm.values[2 * i]
                        = (t / n.xSegCount) * 2 - 1),
                  (n.attributes.uvNorm.values[2 * i + 1] = 1
                        - (e / n.ySegCount) * 2),
                  t < n.xSegCount && e < n.ySegCount)
                ) {
                  const s = e * n.xSegCount + t;
                  (n.attributes.index.values[6 * s] = i),
                  (n.attributes.index.values[6 * s + 1] = i + 1
                        + n.xSegCount),
                  (n.attributes.index.values[6 * s + 2] = i + 1),
                  (n.attributes.index.values[6 * s + 3] = i + 1),
                  (n.attributes.index.values[6 * s + 4] = i + 1
                        + n.xSegCount),
                  (n.attributes.index.values[6 * s + 5] = i + 2
                        + n.xSegCount)
                }
              }
            }
...
class Gradient {
  ...
  constructor(...t) {
    ...
    e(this, 'resize', () => {
      ...
      (this.mesh.material.uniforms.u_shadow_power.value = this.width < 600
        ? 5
        : 6)
    }),
  ...
  shouldSkipFrame(e) {
    return (
      ...
      || !this.conf.playing || parseInt(e, 10) % 2 == 0
      || void 0
    )
  }
